...
namespace game {
    partial class Adventure {
        ...
        /*
         * Additional vocab for Console Application
         * q
         * quit
         * i
         * inventory
         *   --- note that i and inventory are categorized as verbs because they are
         *   --- shorthand for "look at inventory"
         *   save
         *   load
         */
       ...
       * */
        ...
        private string ProcessVerb(List<WordAndType> command) {
            ...
            if(wt.Type != WT.VERB) {
                ...
                switch(wt.Word) {
                    case "i":               // inventory command added
                    case "inventory":
                        s = ShowInventory();
                        break;
                    case "look":
